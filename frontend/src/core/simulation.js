...
BioBLESS.simulation.refresh = function(){
    ...
    $.ajax({
        ...
        success: function(data) {
			...
			BioBLESS.base_stage.removeChild(BioBLESS.stage);
            BioBLESS.base_stage.addChild(BioBLESS.simulation.stage);
            BioBLESS.base_stage.addChild(BioBLESS.navigation);
            BioBLESS.stage = BioBLESS.simulation.stage;
            BioBLESS.navigation.tag.y = BioBLESS.navigation.button[BioBLESS.simulation.tag_index].y;
